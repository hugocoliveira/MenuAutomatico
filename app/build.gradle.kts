...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 56   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.56" // versão legível exibida na tela de login e nas notificações OTA
