...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 24   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.24" // versão legível exibida na tela de login e nas notificações OTA
