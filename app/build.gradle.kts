...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 55   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.55" // versão legível exibida na tela de login e nas notificações OTA
