...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 26   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.26" // versão legível exibida na tela de login e nas notificações OTA
