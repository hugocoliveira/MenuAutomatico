...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 30   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.30" // versão legível exibida na tela de login e nas notificações OTA
