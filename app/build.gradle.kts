...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 53   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.53" // versão legível exibida na tela de login e nas notificações OTA
