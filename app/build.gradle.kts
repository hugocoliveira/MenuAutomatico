...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 46   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.46" // versão legível exibida na tela de login e nas notificações OTA
