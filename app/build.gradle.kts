...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 47   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.47" // versão legível exibida na tela de login e nas notificações OTA
