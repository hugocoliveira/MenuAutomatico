...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 40   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.40" // versão legível exibida na tela de login e nas notificações OTA
