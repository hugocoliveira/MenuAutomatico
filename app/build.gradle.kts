...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 61   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.61" // versão legível exibida na tela de login e nas notificações OTA
