...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 51   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.51" // versão legível exibida na tela de login e nas notificações OTA
