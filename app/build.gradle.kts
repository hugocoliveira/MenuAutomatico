...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 25   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.25" // versão legível exibida na tela de login e nas notificações OTA
