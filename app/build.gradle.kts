...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 35   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.35" // versão legível exibida na tela de login e nas notificações OTA
