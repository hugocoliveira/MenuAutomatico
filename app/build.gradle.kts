...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 59   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.59" // versão legível exibida na tela de login e nas notificações OTA
