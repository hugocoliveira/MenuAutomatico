...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 50   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.50" // versão legível exibida na tela de login e nas notificações OTA
