...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 42   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.42" // versão legível exibida na tela de login e nas notificações OTA
