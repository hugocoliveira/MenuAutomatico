...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 28   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.28" // versão legível exibida na tela de login e nas notificações OTA
