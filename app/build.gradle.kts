...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 38   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.38" // versão legível exibida na tela de login e nas notificações OTA
