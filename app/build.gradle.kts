...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 48   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.48" // versão legível exibida na tela de login e nas notificações OTA
