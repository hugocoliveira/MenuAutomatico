...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 45   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.45" // versão legível exibida na tela de login e nas notificações OTA
