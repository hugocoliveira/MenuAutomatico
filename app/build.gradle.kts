...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 52   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.52" // versão legível exibida na tela de login e nas notificações OTA
