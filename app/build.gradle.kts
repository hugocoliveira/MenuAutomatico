...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 44   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.44" // versão legível exibida na tela de login e nas notificações OTA
