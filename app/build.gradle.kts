...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 43   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.43" // versão legível exibida na tela de login e nas notificações OTA
