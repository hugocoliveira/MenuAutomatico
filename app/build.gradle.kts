...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 34   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.34" // versão legível exibida na tela de login e nas notificações OTA
