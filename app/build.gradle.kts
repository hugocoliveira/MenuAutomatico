...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 33   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.33" // versão legível exibida na tela de login e nas notificações OTA
