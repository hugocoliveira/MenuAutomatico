...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 39   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.39" // versão legível exibida na tela de login e nas notificações OTA
