...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 32   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.32" // versão legível exibida na tela de login e nas notificações OTA
