...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 29   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.29" // versão legível exibida na tela de login e nas notificações OTA
