...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 49   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.49" // versão legível exibida na tela de login e nas notificações OTA
