...
android {
    ...
    defaultConfig {
        ...
        versionCode   = 60   // número inteiro incremental — usado pelo sistema para detectar atualização
        versionName   = "1.60" // versão legível exibida na tela de login e nas notificações OTA
